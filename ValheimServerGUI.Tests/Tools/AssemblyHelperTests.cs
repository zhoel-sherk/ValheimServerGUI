...
{
    /// <summary>
    /// Locks the version-precedence behavior the update notification depends on. The UI shows
    ...
    public class AssemblyHelperTests
    {
        ...
        // the running build is "ahead", which the UI surfaces as a pre-release build.
